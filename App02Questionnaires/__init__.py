...
class Constants(BaseConstants):
    name_in_url = 'App02Questionnaires'
    players_per_group = 3
    num_rounds = 1
...
class Player(BasePlayer):
    ...
    social_cohesion_5 = make_field('The members of my team seemed to make an effort to behave in a way that is acceptable to others.')
    ...
    time_1 = make_field2('How much would you be willing to give up on something that benefits you today in order to benefit more in the future?')
    negative_rp_1 = make_field2('How much would you be willing to punish someone who treated YOU unfairly, even if this would have negative consequences for you?')
    negative_rp_2 = make_field2('How much would you be willing to punish someone who treated OTHERS unfairly, even if this would incur costs for you?')
    altruism_1 = make_field2('How much would you be willing to give for a good cause, without expecting anything in return?')
    ...
    negative_rp_3 = make_field2('If I am treated very unfairly, I will seek revenge at the first opportunity, even if it costs me to do so.')
    ...
    collective_orientation_3_n = make_field("I prefer to complete a task from start to finish without the support of others.")
    collective_orientation_4_p = make_field("Teams usually work very effectively.")
    collective_orientation_5_n = make_field("I think it is usually better to take the bull by the horns and do something myself than to wait for input from others.")
    ...
    collective_orientation_11_n = make_field("If I disagree with other team members, I tend to follow my own gut feeling.")
    collective_orientation_12_n = make_field("If I have a different opinion than another team member, I usually try to stick to my own opinion.")
    collective_orientation_13_n = make_field("It is important to stick to your own opinion, especially when others around you try to persuade you to change it.")
    collective_orientation_14_n = make_field("When others disagree, it is important to stand firm and not give in.")
    collective_orientation_15_n = make_field("Even in teamwork, I believe you should always do what you think is right.")
    collective_orientation_16_n = make_field("If I am convinced of something, I stick to my opinion, no matter what other team members say.")
    attention4 = make_field('Please select the option "strongly agree" to show that you are answering the questions attentively.')
    ...
    psychological_availability_1 = make_field('I am confident that I was able to handle competing demands during the video meeting.')
    psychological_availability_2 = make_field('I am confident that I was able to deal with problems that arose during the video meeting.')
    psychological_availability_3 = make_field('I am confident that I was able to think clearly during the video meeting.')
    psychological_availability_4 = make_field('I am confident that I was able to show the right emotions during the video meeting.')
    psychological_availability_5 = make_field('I am confident that I was able to cope with the physical demands during the video meeting.')
    ...
    engagement_18 = make_field('The fulfillment of my task in the video meeting was so captivating that I forgot everything else.')
    ...
    gender = models.IntegerField(label='<br>Please enter your <strong>gender</strong>.', choices=[[1,'female'], [2,'male'], [3,'diverse']])
    studies = models.StringField(label="<br>Please enter your <strong>current field of study</strong>.")
    ethnicity = models.IntegerField(label="<br>Please indicate which <strong>ethnicity</strong> you would <u>most likely</u> identify with.", choices=[[1,'Asian or Pacific'], [2,'Black or African American'], [3,'Hispanic or Latino'], [4, 'White or Caucasian']])
    economics = models.IntegerField(label="<br>Please indicate whether you have ever participated in an <strong>economic study</strong>.", choices=[[1, "Yes"], [2, "No"]])
    familiarity = models.IntegerField(label="<br>Please indicate whether you have <strong>encountered a member of your team before participating in this study</strong>.", choices=[[1,'No, never encountered before'], [2,'Yes, encountered casually before'], [3,'Yes, we know each other']])
...
class Quest02(Page):
    ...
    def get_form_fields(player):
        import random
        soco = ['social_cohesion_1', 'social_cohesion_2', 'social_cohesion_3', 'social_cohesion_4', 'social_cohesion_5', 'social_cohesion_6', 'attention1']
        random.shuffle(soco)
        return soco
...
class Quest05(Page):
    form_model = 'player'
    form_fields = ['positive_rp_1', 'negative_rp_3', 'trust_1_positive', 'trust_2_negative', 'trust_3_positive', 'attention3', 'math', 'time_2']
...
class Quest08(Page):
    ...
    def get_form_fields(player):
        import random
        collective = ['collective_orientation_1_p', 'collective_orientation_2_n', 'collective_orientation_3_n', 'collective_orientation_4_p', "collective_orientation_5_n", "collective_orientation_6_n", "collective_orientation_7_n", "collective_orientation_8_n", "collective_orientation_9_p", 'collective_orientation_10_n', 'collective_orientation_11_n', 'collective_orientation_12_n', 'collective_orientation_13_n', 'collective_orientation_14_n', 'collective_orientation_15_n', 'collective_orientation_16_n', 'attention4']
...
class Quest09(Page):
    form_model = 'player'
    form_fields = ['gaze_anxiety_1', 'gaze_anxiety_2', 'gaze_anxiety_3', 'gaze_anxiety_4', "gaze_anxiety_5", "gaze_anxiety_6", "gaze_anxiety_7", "gaze_anxiety_8", "gaze_anxiety_9", 'gaze_anxiety_10', 'gaze_anxiety_11', 'gaze_anxiety_12', 'gaze_anxiety_13', 'gaze_anxiety_14', 'gaze_anxiety_15', 'gaze_anxiety_16', 'gaze_anxiety_17']
...
class Quest10(Page):
    form_model = 'player'
    form_fields = ['psychological_safety_1', 'psychological_safety_2', 'psychological_safety_3', 'psychological_availability_1', 'psychological_availability_2', 'psychological_availability_3', 'psychological_availability_4', 'psychological_availability_5']

class Quest11(Page):
    form_model = 'player'
    form_fields = ['engagement_1', 'engagement_2', 'engagement_3', 'engagement_4', 'engagement_5', 'engagement_6', 'engagement_7', 'engagement_8', 'engagement_9', 'engagement_10', 'engagement_11', 'engagement_12', 'engagement_13', 'engagement_14', 'engagement_15', 'engagement_16', 'engagement_17', 'engagement_18', 'engagement_19', 'engagement_20', 'engagement_21', 'engagement_22', 'engagement_23', 'engagement_24', 'engagement_25', 'engagement_26', 'engagement_27', 'engagement_28', 'engagement_29', 'engagement_30']
